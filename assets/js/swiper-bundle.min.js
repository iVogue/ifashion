  ...
  var B = {
        ...
        updateSlides: function () {
          ...
          if (void 0 !== s) {
              ...
              if (t.slidesPerColumn > 1) {
                ...
                if ('row' === t.slidesPerColumnFill && t.slidesPerGroup > 1) {
                  ...
                  'column' === t.slidesPerColumnFill
                    ? ((A = $ - (O = Math.floor($ / P)) * P), (O > k || (O === k && A === P - 1)) && (A += 1) >= P && ((A = 0), (O += 1)))
                    : (O = $ - (A = Math.floor($ / z)) * z);
            ...
            if (
              (0 === p.length && (p = [0]),
              0 !== t.spaceBetween &&
                (this.isHorizontal() ? (a ? d.filter(v).css({ marginLeft: y + 'px' }) : d.filter(v).css({ marginRight: y + 'px' })) : d.filter(v).css({ marginBottom: y + 'px' })),
    ...
    R = {
      update: function (e) {
        ...
        else for (var P = h; P <= p; P += 1) (P < b || P > E) && t.$wrapperEl.find('.' + t.params.slideClass + '[data-swiper-slide-index="' + P + '"]').remove();
    ...
    ee = {
      ...
      enable: function () {
        ...
        if (!t.enabled) {
          ...
          e.gestures
            ? (this.$wrapperEl.on('gesturestart', a, t.onGestureStart, i), this.$wrapperEl.on('gesturechange', a, t.onGestureChange, i), this.$wrapperEl.on('gestureend', a, t.onGestureEnd, i))
      ...
      disable: function () {
        ...
        if (e.enabled) {
          ...
          var i = !('touchstart' !== this.touchEvents.start || !t.passiveListener || !this.params.passiveListeners) && { passive: !0, capture: !1 },
            ...
            a = '.' + this.params.slideClass;
          t.gestures
            ? (this.$wrapperEl.off('gesturestart', a, e.onGestureStart, i), this.$wrapperEl.off('gesturechange', a, e.onGestureChange, i), this.$wrapperEl.off('gestureend', a, e.onGestureEnd, i))
            : 'touchstart' === this.touchEvents.start &&
