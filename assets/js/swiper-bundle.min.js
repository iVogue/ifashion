                  ...
                  var D = Math.floor(
                    ...
                    N =
                      0 === D
                        ? t.slidesPerGroup
                        : Math.min(
                            Math.ceil((h - D * P * t.slidesPerGroup) / P),
                            t.slidesPerGroup
                          );
                  (I =
                    (O =
      ...
      disable: function () {
        ...
        if (e.enabled) {
          ...
          var i = !(
            ...
            a = '.' + this.params.slideClass;
          t.gestures
            ? (this.$wrapperEl.off('gesturestart', a, e.onGestureStart, i),
              this.$wrapperEl.off('gesturechange', a, e.onGestureChange, i),
              this.$wrapperEl.off('gestureend', a, e.onGestureEnd, i))
            : 'touchstart' === this.touchEvents.start &&
              (this.$wrapperEl.off(
                this.touchEvents.start,
                a,
